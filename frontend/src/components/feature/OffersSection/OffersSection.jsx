...
const offers = [
    {
        ...
        buttonText: 'Book Now',
        bgColor: 'bg-gradient-to-r from-gray-100 to-gray-500',
    },
    {
        id: '2',
        title: 'Feel the Rush!',
        ...
        bgColor: 'bg-gradient-to-r from-grap-100 to-gray-500',
    },
    {
        id: '3',
        ...
        bgColor: 'bg-gradient-to-r from-gray-100 to-purple-500',
    },
];
