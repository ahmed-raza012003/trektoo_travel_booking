...
const ActivitiesPage = () => {
  ...
  const activities = [
    ...
    {
      id: 2,
      name: 'Bangkok Temple Experience',
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">
            Manage and monitor all your travel activities
          </p>
        </div>
      ...
      >
        {filteredActivities.map((activity) => (
          <div key={activity.id} className="bg-white shadow rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
            {/* Activity Image */}
